...
public class ContactSurfaceController : SurfaceController
{
    ...
    private readonly ILogger<ContactSurfaceController> _looger;
    ...
    public async Task<IActionResult> Submit(ContantViewModel model)
    {
        ...
        try
        {
            ...
            EmailMessage message = new(_freelancerConfig?.EmailSettings?.From, _freelancerConfig?.EmailSettings?.To, subject, model.Message, false);
        ...
        {
            _looger.LogError(ex, "Contact Form Submission Error");
